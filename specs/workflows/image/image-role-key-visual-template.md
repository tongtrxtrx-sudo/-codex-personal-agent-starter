...
```text
single character key visual, {{角色描述}}, {{服装和特征}}, {{表情和姿态}}, {{风格方向}}, {{光影氛围}}, restrained background, poster-ready composition with strong silhouette and clear focal center
```
...
```text
single character illustration, {{角色描述}}, {{气质和表情}}, {{风格方向}}, atmospheric background, premium cinematic mood, clean composition, suitable for smartphone wallpaper
```
...
```text
stylized character illustration, {{角色描述}}, {{Q版或手办风说明}}, {{风格变体关键词}}, {{光线或材质感}}, clean background, collectible visual quality
```
